...
| ----------------------------------- | ------------------------------------------------------- |
| GOMEZ HORMAZA, LEONARDO FABIO       | [LEONARDO.GOMEZ@UPCH.PE](mailto:LEONARDO.GOMEZ@UPCH.PE) |
...
Contiene los certificados correspondientes a los cursos realizados en CITI Program.

### 2. Laboratorios

Contiene los trabajos y actividades desarrollados durante las sesiones de laboratorio.

* **Lab_01:** Introducción al uso de Git y GitHub.
* **Lab_02:** Próximamente.
* **Lab_03:** Próximamente.
* **...**

Cada laboratorio contiene los archivos, códigos, resultados y documentación correspondiente a la actividad realizada.

### 3. Proyecto

Contiene los avances y materiales relacionados con el proyecto final del curso.

* **Hardware:** componentes, conexiones, esquemas y elementos utilizados para la implementación.
* **Software:** códigos, programas y procesamiento de las señales biomédicas.
